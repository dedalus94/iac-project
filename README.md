...
* SecurityGroup (Type: AWS::EC2::SecurityGroup): This security group is created for the VPC deployed by using the network.yml template - the *VPC id* is imported from the Outputs generated by deploying network.yml using the intrinsic function Fn::ImportValue.
